...
--테이블 생성
CREATE TABLE author (id bigint(20) NOT NULL AUTO_INCREMENT, email varchar(255) DEFAULT NULL, 
PRIMARY KEY (id));
...
BEGIN
    ...
    WHILE iteration <= max_iterations DO
        ...
        WHILE i <= iteration * batch_size DO
            SET email = CONCAT('cogns', i, '@naver.com');
